...
class GatewayAgentCacheMixin:
    ...
    def _interrupt_running_turn(self, session_key: str, *, interrupt_reason: str, invalidation_reason: str) -> int:
        ...
        # Cancel any pending clarify entries for this session so a blocked agent
        # thread waiting on tools.clarify_gateway unwinds promptly on interrupt
        # instead of sitting through the full 10-minute wait_for_response timeout.
        try:
