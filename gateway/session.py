...
_CHAT_TYPE_PREFIX = {"group": "group: ", "channel": "channel: ", "thread": "thread in "}
...
class SessionSource:
    ...
    def description(self) -> str:
        ...
        return f"{desc}, thread: {self.thread_id}" if self.thread_id and self.chat_type != "thread" else desc
